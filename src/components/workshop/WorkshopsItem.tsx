 ...
 return (
  <Card className="hover:border-main-500 transition ease-in-out duration-300">
   <CardHeader className="p-0">
    <img src={workshop.coverUrl} className="h-40 object-cover rounded-t-lg" alt="" />
   ...
   <CardFooter className="flex p-4 justify-between">
    <small> {t("workshop_card.date")} <span className="font-semibold">{formatDate({ date: workshop.createdAt, locale: storedLang || "fr" })}</span></small>
