...
const WorkshopsList = () => {
 ...
 return (
  <div className={`grid grid-cols-4 gap-8 ${workshops && workshops.length === 0 && "relative h-[65vh]"}`}>
   {isLoading ? (
    <>
     <SkeletonCard />
     <SkeletonCard />
    ...
    workshops.length > 0 ? (
     ...
     <p className="text-black/75">Vous n'avez pour l'instant aucun ateliers</p>
    </div>
   ) : isError ? (
    <Error />
   ) : null}
