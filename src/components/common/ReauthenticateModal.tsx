...
const ReauthenticateModal = ({ isOpen, setIsOpen, newEmail, setNewEmail }: { isOpen: boolean; setIsOpen: (value: boolean) => void, newEmail: string; setNewEmail: (value: string | null) => void }) => {
 ...
 const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
  ...
  const confirmed = window.confirm(`Please confirm that you've verified the new email: ${newEmail}`);
